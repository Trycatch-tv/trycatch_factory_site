...
import authories from "../service/authGoogle";
import { createSpreadsheet, googleSheetSave, insertHeader } from "../service/googlesheet";

const auth = await authories.authorize();
const spreadsheetId = await createSpreadsheet(auth);
await insertHeader(auth, spreadsheetId);
...
export const useSubmitHandler = () => {
    const handleSubmit = async (event: any) => {
      ...
      try {
        ...
        await googleSheetSave(dataPost, auth, spreadsheetId);
